                    ...
                    <div className="navbar-nav mb-2 mb-md-0 row">
                        <li className="nav-item dropdown mx-5 col">
                            ...
                            <ul className="dropdown-menu">
                                <li><a className="dropdown-item" href="#">Deck box</a></li>
                                <li><a className="dropdown-item" href="#">Tapis de jeu</a></li>
                                <li><a className="dropdown-item" href="#">Sleeves</a></li>
                            </ul>
                        </li>
                        <li className="nav-item dropdown mx-5 col">
                            <a className="nav-link dropdown-toggle " href="#" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <ul className="dropdown-menu">
                                <li><a className="dropdown-item" href="#">Cartes</a></li>
                                <li><a className="dropdown-item" href="#">Boosters</a></li>
                                <li><a className="dropdown-item" href="#">Boites</a></li>
                            </ul>
                        </li>
                        <li className="nav-item dropdown mx-5 col flex justify-content-center">
                            <a className="nav-link dropdown-toggle " href="#" data-bs-toggle="dropdown" aria-expanded="false">
                                nouveautés
                            </a>
                            <ul className="dropdown-menu">
                                <li><a className="dropdown-item" href="#">Rien</a></li>
                                <li><a className="dropdown-item" href="#">Encore Rien</a></li>
                                <li><a className="dropdown-item" href="#">Toujours Rien</a></li>
                            </ul>
                        </li>
                    </div>
                </div>
